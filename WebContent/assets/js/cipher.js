                ...
                .get(buildCipherPostURL(), $form.serialize(), function(response) {
                  ...
                  if (cipherDirection === "Encrypt") {
                    ...
                    if (cipherDirection === "AutoDecrypt") {
                      ...
                      // When select dynamic value from json, it
                      // can't have a period in it.
                ...
                .fail(function(errors) {
                  ...
                  errors.responseJSON.fieldErrors
                      .forEach(function(error) {
                        // if error.field == text.text then
                        // change to text
                        // We do this because the name attribute
                        // for plainText and cipherText is just
                        // "text"
