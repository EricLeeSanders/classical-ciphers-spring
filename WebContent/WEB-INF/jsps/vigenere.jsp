...
<body>
    ...
    <div id="main-content">
      <div id="cipher-input">
      <sf:form method="post" action="${pageContext.request.contextPath}/vigenere" commandName="vigenere">
        <div id ="vigenere-cipher-input" class="selected-cipher">
	    	<label> Key: </label>
	    	<input type="text" name=key id="vigenere-key" value="${vigenere.key}"/>
        </div>
        <br>
        <label>Plain Text</label>
        <br>
        <textarea name="plainText" id="plain-text" placeholder="Plain text"><c:out value="${vigenere.plainText}"></c:out></textarea>
        <br>
        <label>Cipher Text</label>
        <br>
        <textarea name="cipherText" id="cipher-text" placeholder="Cipher text"><c:out value="${vigenere.cipherText}"></c:out></textarea>
        <br>
